...
def setup_bot_handlers(bot):
    ...
    def change_manager_contact(message):
        # Здесь должна быть логика для изменения контакта менеджера
        bot.send_message(message.chat.id, "Отправьте новый контакт менеджера.")
    ...
    def change_channel_link(message):
        # Здесь должна быть логика для изменения ссылки на канал
        bot.send_message(message.chat.id, "Отправьте новую ссылку на канал.")
