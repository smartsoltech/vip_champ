...
def setup_bot_handlers(bot):
    ...
    def add_admin_command(message):
        if not is_superadmin(message.from_user.username, SUPERADMIN_PASSWORD):
    ...
    def process_add_admin_step(message):
        try:
            ...
            bot.reply_to(message, "Error in input. Please enter username and password separated by space.")
