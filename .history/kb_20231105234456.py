...
def generate_contact_keyboard():
    ...
    buttons = [
            ...
            types.InlineKeyboardButton(text="📢 Перейти в канал", url="https://t.me/+E6Xo5rKob8k4MzIy")
            types.InlineKeyboardButton(text="💬 Перейти в чат", url="https://t.me/HappyWeekendVip_bot")
