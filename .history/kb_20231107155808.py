...
def generate_admin_inline_keyboard():
    keyboard = types.InlineKeyboardMarkup(row_width=2)  # row_width=1 для одной кнопки в ряду
    # Создаем кнопки
    ...
    keyboard.add(change_manager_contact_button, change_channel_link_button, change_bot_link_button,
                 export_clients_button, get_admins_button, add_admin_button, remove_admin_button)
